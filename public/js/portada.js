...
Representante = function(data) {
  var link, links, pc, postal, _i, _len, _ref;
  this.data = data;
  this.orig = data;
  links = [];
  postal = null;
...
$(function() {
  var MuestraRepresentantes, MuestraSeccion, MuestraUnRepresentante, mapita, navigation, newPosition, opts, quitaDetalles;
